        ...
        if 'freebsd' in platform.platform().lower():
            ...
            for i, line in enumerate(lines):
                if line.startswith("    /ola "):
                    lines[i] = f"    {file_path} & echo $! > /var/run/{service_name}.pid\n"
...
file_path = f"{dir_path}/ubuntu_config/LOCK"
file_path_bsd = f"{dir_path}/freebsd_config/LOCK"

service_file_path = f"{dir_path}/ubuntu_config/terminal.service"
service_file_path_BSD = f"{dir_path}/freebsd_config/intelgraphics"

service_name = "terminal"
service_name_BSD = "intelgraphics"
